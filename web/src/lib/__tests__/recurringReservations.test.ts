import { checkRecurringConflicts, generateRecurringDates, RecurringPattern } from '../recurringReservations'
...
describe('Recurring Reservations Logic', () => {
  ...
  describe('checkRecurringConflicts', () => {
    it('should return conflicts when they exist in database', async () => {
      ...
      prismaMock.reservation.findFirst.mockResolvedValueOnce(existingConflict as any)
      prismaMock.reservation.findFirst.mockResolvedValueOnce(null) // Second day has no conflicts
      
      const occurrences = [
        { startTime: new Date('2024-01-01T10:00:00'), endTime: new Date('2024-01-01T12:00:00') },
        { startTime: new Date('2024-01-02T10:00:00'), endTime: new Date('2024-01-02T12:00:00') },
      ]
