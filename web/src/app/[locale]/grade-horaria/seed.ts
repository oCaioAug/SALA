...
const professoresMock: ProfessorMock[] = [
  {
    ...
    disponibilidades: [
      { dia: 'SEG', turno: 'M1' }, { dia: 'SEG', turno: 'M2' },
      { dia: 'TER', turno: 'M1' }, { dia: 'TER', turno: 'M2' },
    ],
  },
  {
    id: 'P2',
    ...
    disponibilidades: [
      { dia: 'QUA', turno: 'M1' }, { dia: 'QUA', turno: 'M2' },
      { dia: 'QUI', turno: 'M1' }, { dia: 'QUI', turno: 'M2' },
      { dia: 'SEX', turno: 'M1' },
    ],
  },
  {
    ...
    disponibilidades: [
      { dia: 'SEG', turno: 'M1' },
      { dia: 'QUA', turno: 'M2' },
      { dia: 'SEX', turno: 'M1' }, { dia: 'SEX', turno: 'M2' },
    ],
  },
];
...
const cargaHorariaMock: CargaHorariaMock[] = [
  ...
  { id: 'CH1', professorId: 'P1', turmaId: 'T1', disciplinaId: 'D1', quantidadeAulas: 2 },
  { id: 'CH2', professorId: 'P2', turmaId: 'T1', disciplinaId: 'D3', quantidadeAulas: 2 },

  // Aulas da Turma 2 (Total: 5 aulas necessárias)
  { id: 'CH3', professorId: 'P1', turmaId: 'T2', disciplinaId: 'D2', quantidadeAulas: 2 }, // Conflito de agenda para o P1!
  { id: 'CH4', professorId: 'P2', turmaId: 'T2', disciplinaId: 'D4', quantidadeAulas: 1 },
  { id: 'CH5', professorId: 'P3', turmaId: 'T2', disciplinaId: 'D1', quantidadeAulas: 2 }, 
];
      ...
      shifts: [
        {
          ...
          daysPerWeek: 5,
          slots: [
            { id: "M1", label: "M1 (08h-10h)", startTime: "08:00", endTime: "10:00" },
            { id: "M2", label: "M2 (10h-12h)", startTime: "10:00", endTime: "12:00" }
          ]
        }
      ]
    }
