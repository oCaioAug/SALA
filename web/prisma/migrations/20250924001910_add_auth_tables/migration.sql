...
-- CreateEnum
CREATE TYPE "public"."RoomStatus" AS ENUM ('LIVRE', 'EM_USO', 'RESERVADO');
...
CREATE TABLE "public"."rooms" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "status" "public"."RoomStatus" NOT NULL DEFAULT 'LIVRE',
    "capacity" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."items" ADD CONSTRAINT "items_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "public"."rooms"("id") ON DELETE SET NULL ON UPDATE CASCADE;
