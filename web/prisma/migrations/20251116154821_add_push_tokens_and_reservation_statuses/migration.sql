-- CreateEnum
CREATE TYPE "public"."NotificationType" AS ENUM ('RESERVATION_CREATED', 'RESERVATION_APPROVED', 'RESERVATION_REJECTED', 'RESERVATION_CANCELLED', 'RESERVATION_CONFLICT', 'RESERVATION_REMINDER', 'ROOM_STATUS_CHANGED', 'SYSTEM_ANNOUNCEMENT', 'INCIDENT_CREATED', 'INCIDENT_ASSIGNED', 'INCIDENT_STATUS_CHANGED', 'INCIDENT_RESOLVED');
